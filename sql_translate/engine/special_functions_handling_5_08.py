...
class SpecialFunctionHandlerImpalaToPresto(_SpecialFunctionHandler):
    def __init__(self) -> None:
        self.special_functions = {
            ...
            "left" : self.left,
            "strleft" : self.strleft,
            "right" : self.right,
            "strright" : self.strright
        }
    ...
    def left(self, function_info: Dict, function_name_formatting: str, input_arguments_clean: List[str], str_output_arguments_composed: List[str]) -> str:
        
        translated_function_call = function_info["translation"] + function_name_formatting + "(" + str_output_arguments_composed[0]  + ",1,"  + str_output_arguments_composed[1] + ")"
        return f"{translated_function_call}"
    
    def strleft(self, function_info: Dict, function_name_formatting: str, input_arguments_clean: List[str], str_output_arguments_composed: List[str]) -> str:
        
        translated_function_call = function_info["translation"] + function_name_formatting + "(" + str_output_arguments_composed[0]  + ",1,"  + str_output_arguments_composed[1] + ")"
        return f"{translated_function_call}"
    
    def right(self, function_info: Dict, function_name_formatting: str, input_arguments_clean: List[str], str_output_arguments_composed: List[str]) -> str:
        
        translated_function_call = function_info["translation"] + function_name_formatting + "(" + str_output_arguments_composed[0]  + ","  + "-" + str_output_arguments_composed[1] + ")"
        return f"{translated_function_call}"
    
    def strright(self, function_info: Dict, function_name_formatting: str, input_arguments_clean: List[str], str_output_arguments_composed: List[str]) -> str:
    ...
    def from_utc_timestamp(self, function_info: Dict, function_name_formatting: str, input_arguments_clean: List[str], str_output_arguments_composed: List[str]) -> str:
        ...
        Returns:
            str: Translated function call
        """
        return f"cast({str_output_arguments_composed[0]} as timestamp) AT TIME ZONE {self.timezone_translation[str_output_arguments_composed[1]]}"
