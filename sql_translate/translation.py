...
class ImpalaToPresto(_Translator):
    def __init__(
        self,
        ...
        self.GlobalTranslator = global_translation.GlobalImpalaToPresto()
        self.RecursiveTranslator = recursive_translation.RecursiveImpalaToPresto()

    def _mask_tokens_that_are_note_impala_keywords(self, query: str) -> str:
        """Certain words are better processed masked so they are tagged as Identifier by sqlparse, not Keyword.
        The masking can be removed by _unmask_tokens_that_are_note_impala_keywords
    ...
    def _unmask_tokens_that_are_note_impala_keywords(self, query: str) -> str:
        """Remove the Keyword masking done by _mask_tokens_that_are_note_impala_keywords
    ...
    def translate_statement(self, input_statement: str, has_insert_statement: bool = True, verbose: bool = False) -> str:
        ...
        Args:
            input_statement (str): Input Impala SQL statement
        ...
        try:
            ...
            for input_query in input_queries:
                ...
                formatted_input_query = self._mask_tokens_that_are_note_impala_keywords(formatted_input_query)
                ...
                final_translation = self._unmask_tokens_that_are_note_impala_keywords(recursive_translation)
    ...
    def translate_file(self, path_file: str) -> str:
        """Translate a Impala SQL file to Presto SQL
